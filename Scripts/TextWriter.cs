...
//script that handles snail NPC text writing on start menu, sets remaining text to invisible so that the text position stays the same instead of constantly updating and moving, from tutorial followed
